...
int main()
{
	...
	DiamondTrap player_seven;
	DiamondTrap player_eight(player_name);
	DiamondTrap player_nine(player_seven);
    std::cout << "\n" << "========================================================================= " << "\n\n";

	player_seven.whoAmI();
	player_seven.attack(enemy_name);
	player_eight.whoAmI();
	player_eight.attack(player_clone);
	player_nine.whoAmI();
    std::cout << "\n" << "========================================================================= " << "\n\n";
    return (0);
}
